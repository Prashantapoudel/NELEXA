...
recognition.onresult = (e) => {
  ...
  if (transcript.includes("hello")) {
    ...
    synth.speak(utter);
  } else if (transcript.includes("fastest net")) {
    recognition.stop();
    utter.text = "In my opinion worldlink is fastest net in Nepal";
    synth.speak(utter);
    ...
    synth.speak(utter);
    window.open(song)
  } else if (transcript.includes("open Worldlink")) {

    recognition.stop();
    utter.text = "Opeaning Worldlink Page";
    synth.speak(utter);
    window.open(`https://worldlink.com.np/`)
  } else if (transcript.includes("open Tech Himalayan")) {

    recognition.stop();
    utter.text = "Opeaning Tech Himalayan Page";
    synth.speak(utter);
    window.open(`https://techhimalaya.com/`)
