...
const transcript = e.results[e.results.length-1][0].transcript.trim();
   ...
   {
     recognition.stop();
        const music = new Audio(`./audio/my.mp3`);
      music.play();
    } else if(transcript.includes("Timro Naam"))
   {
     recognition.stop();
        const music = new Audio(`./audio/nelexa.mp3`);
        music.play();
   } else if(transcript.includes("Naam k"))
   {
     recognition.stop();
        const music = new Audio(`./audio/nelexa.mp3`);
        music.play();
   }else if(transcript.includes("Naam kya"))
   {
     recognition.stop();
        const music = new Audio(`./audio/nelexa.mp3`);
        music.play();
      ...
      } else if(transcript.includes("banaco"))
   {
     recognition.stop();
        const music = new Audio(`./audio/whomade.mp3`);
      music.play();
   } else if(transcript.includes("banaa"))
   {
     recognition.stop();
        const music = new Audio(`./audio/whomade.mp3`);
      music.play();
 ...
 let song = son[Math.floor(Math.random() * son.length)]
    ...
    } else if(transcript.includes("b i c"))
    {
        recognition.stop();
         const music = new Audio(`./audio/hack.mp3`);
      music.play();
    } else if(transcript.includes("pic"))
    {
        recognition.stop();
         const music = new Audio(`./audio/hack.mp3`);
      music.play();
    } else if(transcript.includes("BBC"))
    {
        recognition.stop();
         const music = new Audio(`./audio/hack.mp3`);
      music.play();
    }
     else if(transcript.includes("BSC"))
    {
        recognition.stop();
         const music = new Audio(`./audio/hack.mp3`);
      music.play();
    } else if(transcript.includes("hackathon"))
    {
        recognition.stop();
         const music = new Audio(`./audio/hack.mp3`);
      music.play();
